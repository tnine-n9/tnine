...
local window = library:new("tnine")

local creds = window:Tab("作 者qq号:3562501187",'6035145364')

local bin = creds:section("目前脚本正在测试中",true)
...
local bin = creds:section("自瞄",true)

local credits = creds:section("旋转与范围",true)

    credits:Button("XA脚本",function()
    
	loadstring(game:HttpGet("https://pastebin.com/raw/h8nC0fLb", true))()
    

credits:Toggle("fiy", "", false, function(state)
        if state then
    
    loadstring(game:HttpGet("https://raw.githubusercontent.com/XNEOFF/FlyGuiV3/main/FlyGuiV3.txt"))()
    

credits:Toggle("自瞄以及子追", "", false, function(state)
        if state then
